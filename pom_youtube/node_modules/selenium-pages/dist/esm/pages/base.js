...
export class WebElementEx extends WebElement {
    ...
    querySelectorAll(css) {
        return __awaiter(this, void 0, void 0, function* () {
            return Array
                .from(yield this.findElements(By.css(this.styleDictionary.get(css))))
...
export class PageBase {
    ...
    querySelector(css) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.driver.wait(until.elementLocated(By.css(this.styleDictionary.get(css))), this.options.maxWaitMs)
                .then(webele => new WebElementEx(webele, this.styleDictionary));
        });
    }
    querySelectorAll(css) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return Array.from(yield this.driver.findElements(By.css(this.styleDictionary.get(css))))
                .map(webele => new WebElementEx(webele, this.styleDictionary));
        });
    }
}
